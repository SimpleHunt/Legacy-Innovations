...
export default function ReportPage() {
  ...
  const handleFilter = async () => {
    ...
    const res = await fetch(
      `/api/reports/franchise?startDate=${startDate}&endDate=${endDate}&page=${page}`
    );
  ...
  const downloadExcel = () => {
    window.open(
      `/api/reports/franchise/excel?startDate=${startDate}&endDate=${endDate}`,
      "_blank"
    );
  };
  ...
  const downloadPDF = () => {
    window.open(
      `/api/reports/franchise/pdf?startDate=${startDate}&endDate=${endDate}`,
      "_blank"
    );
  };
