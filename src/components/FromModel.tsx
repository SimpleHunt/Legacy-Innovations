...
const FranchiseForm = dynamic(() => import("./forms/FranchiseForm"), {
  loading: () => <h1>Loading...</h1>,
});
...
const forms: {
  ...
  order: (type, data) => <OrderForm type={type} data={data} />,
  franchise: (type, data) => <FranchiseForm type={type} data={data} />
};
